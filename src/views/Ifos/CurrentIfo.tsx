...
/**
 * Usdt: currently there should be only 1 active IFO at a time
 */
    ...
    <div>
      ...
      <LaunchIfoCallout>
        <div>
          ...
          <List>
            <li>{TranslateString(596, 'Buy CAKE and ETH tokens')}</li>
            <li>{TranslateString(598, 'Get CAKE-ETH LP tokens by adding CAKE and ETH liquidity')}</li>
          </List>
          <Flex mb="16px">
            <LinkExternal href="https://floraswap.org/#/swap" mr="16px">
              {TranslateString(999, 'Buy USDT')}
            </LinkExternal>
            <LinkExternal href="https://floraswap.org/add/USDT">
        ...
        <div>
          ...
          <div>
            ...
            <Text mb={3}>
              {TranslateString(
                514,
                'Launch your project with PancakeSwap, Fantom’s most-used AMM project and liquidity provider, to bring your token directly to the most active and rapidly growing community on BSC.',
              )}
            </Text>
            <Button
              as="a"
